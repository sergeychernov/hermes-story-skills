...
def update_env(path: Path, values: dict[str, str]) -> None:
    ...
    temp = path.with_name(path.name + ".youtube-oauth.tmp")
...
def main() -> None:
    ...
    parser.add_argument("--client-json", type=Path, default=home / ".hermes/secrets/youtube-client.json")
    parser.add_argument("--env-file", type=Path, default=home / ".env")
